...
class FR3(gr.sync_block):
    ...
    def __init__(self, freq, freq2, gain1, gain2, gain3, gain4, ip_address="0.0.0.0"):
        ...
        self.set_gain2(gain2, self.RX_gainmes)
    ...
    def set_gain2(self, gain2, RX_gainmes):
        self._rx2gain = gain2
        self.RX1_gainmes = RX_gainmes
        if RX_gainmes > 0:
            gainrx1 = RX_gainmes
    ...
    def set_gain4(self, gain4, TX_gainmes):
        self._tx2gain = gain4
        self.TX1gainmes = TX_gainmes
        if TX_gainmes > 0:
            gaintx1 = TX_gainmes
